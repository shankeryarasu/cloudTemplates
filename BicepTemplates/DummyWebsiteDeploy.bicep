//actuall name is main.bicep which is copied from Exercise - Add a Bicep deployment task to the pipeline > https://learn.microsoft.com/en-gb/training/modules/build-first-bicep-deployment-pipeline-using-azure-pipelines/6-exercise-add-bicep-deployment-task-pipeline //
 // below the bicep templates there is Pipeline template
